define('aura/ext/components', function() {
  ...
  return function(app) {
     ...
     */
    function parseComponentOptions(el, namespace, options) {
      ...
      return buildComponentOptions(name, ret);
    }
    ...
    function buildComponentOptions(name, options) {
      ...
      var componentsPath    = app.config.components.sources[componentSource] || "components";

      // Register the component a s requirejs package...
    ...
    Component.parseList = function(components) {
      ...
      if (Array.isArray(components)) {
        ...
        var selector = ["[data-aura-component]"];
        if (appNamespace) { selector.push("[data-" + appNamespace + "-component]"); }
    ...
    return {
      ...
      initialize: function(app) {
        ...
        app.core.registerComponentCallback = function(callbackName, fn) {
        ...
        app.core.registerComponentType = function(type, def) {
        ...
        app.core.start = Component.startAll;
