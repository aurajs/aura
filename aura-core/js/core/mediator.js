 ...
 *
 * @todo Change the context to the FACADE when an event is published...
 *
...
define(['jquery', 'underscore'], function ($, _) {
     ...
     * @todo use require to load the module that corresponds to
     * this channel, _then_ push it to the channels list
    ...
    obj.autoload = function (channel) {
        ...
        require(["modules/" + file], function (module) {
            for (i = 0, l = channels[channel].length; i < l; i += 1) {
